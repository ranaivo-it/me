...
Mainly, it provides two well-suited data structures to multiple data type include `Series` and `DataFrame`. This article will get into both of them in the following.  
